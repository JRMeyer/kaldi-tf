...
if [ 1 ]; then
    ...
    # EGS --> CSV
    python3 egs-to-csv.py ${tmp_dir}/org-txt-ark ${tmp_dir}/ark.csv $tmp_dir
...
if [ 1 ]; then
    # PERFORM MAPPING
 	...
 	./faster-mapping.sh $tmp_dir/$egs $tmp_dir/formatted-mapping.txt `cat ${tmp_dir}/DIM` ${tmp_dir} #DIM is a file generated by egs-to-csv.py
...
rm ${tmp_dir}/*-txt-ark ${tmp_dir}/DIM ${tmp_dir}/*.txt ${tmp_dir}/*.csv ${tmp_dir}/*.tfrecords ${tmp_dir}/*.tmp ${tmp_dir}/*.mod
