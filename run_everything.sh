...
./faster-mapping.sh tmp.arkfile mapping.txt `cat DIM` #DIM is a file generated by egs-to-csv.py
cat ARK_split* > $OUTARK


# CLEAN-UP

rm DIM tmp.arkfile ARK_split* mapping.txt kaldi-labels.txt tf-labels.txt combined-labels.txt all.csv eval.csv train.csv all.tfrecords eval.tfrecords train.tfrecords
