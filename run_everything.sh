...
# rm DIM tmp.arkfile ARK_split* mapping.txt tf-labels.txt all.csv kaldi-labels.txt combined-labels.txt eval.csv train.csv all.tfrecords eval.tfrecords train.tfrecords formatted-mapping.txt # #####
